...
function menuByRole(role) {
  ...
  if (r === "fat") {
    return [
      ...
      { to: "/project-assignments", label: "Penugasan Proyek", icon: UserCheck },
      { to: "/schedules", label: "Jadwal", icon: BookOpen },
      { to: "/attendances", label: "Kehadiran", icon: TrendingUp },
      { to: "/mandays-summary", label: "Ringkasan Mandays", icon: ClipboardList },
  ...
  if (r === "hcga") {
    return [
      { to: "/dashboard", label: "Dasbor", icon: LayoutDashboard },
      { to: "/employees", label: "Data Karyawan", icon: Users },
      { to: "/master/grades", label: "Manajemen Grade", icon: FolderOpen },
      { to: "/master/allowance-types", label: "Jenis Tunjangan", icon: ClipboardList },
      { to: "/master/grade-rates", label: "Matriks Tarif Grade", icon: BarChart3 },
      { to: "/accounts/create", label: "Buat Akun", icon: UserCheck },
      { to: "/projects", label: "Proyek", icon: FolderOpen },
      { to: "/project-assignments", label: "Penugasan Proyek", icon: UserCheck },
      { to: "/schedules", label: "Jadwal", icon: BookOpen },
      { to: "/attendances", label: "Kehadiran", icon: TrendingUp },
